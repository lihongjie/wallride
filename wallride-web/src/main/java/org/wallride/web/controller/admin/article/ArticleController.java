...
public class ArticleController {
    ...
    public String create(AuthorizedUser authorizedUser, Model model) {
        ...
        List<Category> categoryList = topicCategoryService.getCategories(authorizedUser);
        model.addAttribute("author", authorizedUser);
    ...
    public ResponseEntity bulkPublish(
            @Valid ArticlePublishRequest articleRequest,
    ...
    public ResponseEntity unpublish(
            @Valid ArticleBulkArchiveRequest articleRequest, BindingResult bindingResult,
            AuthorizedUser authorizedUser) {
