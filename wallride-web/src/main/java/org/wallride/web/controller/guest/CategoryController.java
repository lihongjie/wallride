...
public class CategoryController {
    ...
    public String index(
        ...
        Page<Category> categories = topicCategoryService.getCategories(new CategorySearchRequest(), pageable);
    ...
    public String post(
        ...
        Category category = topicCategoryService.getCategoryByCode(lastCode, language.getLanguage());
        if (category == null) {
            category = topicCategoryService.getCategoryByCode(lastCode, language.getBlog().getDefaultLanguage());
        }
        if (category == null) {
