...
public class CategorySelectController {
	...
	public @ResponseBody List<DomainObjectSelect2Model> select(
		...
		Page<Category> categories = topicCategoryService.getCategories(form.toCategorySearchRequest());
	...
	public DomainObjectSelect2Model select(
		...
		Category category = topicCategoryService.getCategoryById(id, language);
		if (category == null) {
