...
public class CategoryController {
	...
	public String search(@PathVariable String language, CategorySearchForm form,
		...
		Page<Category> categories = topicCategoryService.getCategories(form.toCategorySearchRequest(), pageable);
	...
	public ResponseEntity save(AuthorizedUser authorizedUser, @Valid CategoryCreateForm form) {
		...
		topicCategoryService.createCategory(form.buildCategoryCreateRequest(), authorizedUser);
	...
	public ResponseEntity update(
		...
		form.setId(id);
		topicCategoryService.updateCategory(form.buildCategoryUpdateRequest(), authorizedUser);
		return ResponseEntity
				.status(HttpStatus.OK)
				.build();
	}
	...
	public ResponseEntity delete(
		...
		topicCategoryService.deleteCategory(id, language);
		return ResponseEntity
				.status(HttpStatus.OK)
				.build();
	}
...
//		topicCategoryService.updateCategoryHierarchy(data, language);
