...
public class BlogLanguageRewriteMatch extends RewriteMatch {
	...
	public BlogLanguageRewriteMatch(Language language) {
	...
	public boolean execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String rewritePath = originalPath.replaceAll("^/" + language.getLanguage() + "/", "/");
		matchingUrl = rewritePath;
		logger.debug(originalPath + " => " + rewritePath);

		request.setAttribute(BlogLanguageMethodArgumentResolver.BLOG_LANGUAGE_ATTRIBUTE, language);
